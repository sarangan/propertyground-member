      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'index.php/admin/jobs/add'; ?>">Add New</a></li>
          </ol>
...
<form accept-charset="utf-8" method="POST" action="<?php echo base_url() . 'index.php/admin/jobs/delete'; ?>">
...
<script type="text/javascript">
  $(function () {
    ...
    $('#dataTables-example').dataTable({
        ...
        var modal = $(this)
        modal.find('#project_id').val(recipient);
      });
