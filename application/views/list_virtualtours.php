...
<?php $this->load->view('include/sidebar_admin.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            <i class="fa fa-circle-o-notch"></i> 360 Virutal Tours
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>">Home</a></li>        
            <li class="active"><a onclick="return false;" href="#">Virutal Tours</a></li>
             <li><a href="<?php echo base_url() . 'index.php/admin/virtualTours/add'; ?>">Add New</a></li>
          </ol>
                                                        ...
                                                        echo '
                                                                    ...
                                                                    <td>
                                                                        <span class="tools-icons edit-ico">                             
                                                                            <a data-toggle="tooltip" data-original-title="Edit" href="'. base_url() . 'index.php/admin/virtualTours/add/'.  $war->id .'"><i class="fa fa-pencil"></i></a>
                                                                        </span>
...
<form accept-charset="utf-8" method="POST" action="<?php echo base_url() . 'index.php/admin/virtualTours/delete'; ?>">
