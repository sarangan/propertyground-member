      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a onclick="return false;" href="#">Templates</a></li>
            <li><a href="<?php echo base_url() . 'index.php/admin/templates/add'; ?>">Add New</a></li>
          </ol>
                                                        ...
                                                        echo '
                                                                    ...
                                                                    <td>
                                                                        <span class="tools-icons edit-ico">                             
                                                                            <a  data-toggle="tooltip" data-original-title="Edit" href="'. base_url() . 'index.php/admin/templates/add/'.  $war->id .'"><i class="fa fa-pencil"></i></a>
                                                                        </span>
