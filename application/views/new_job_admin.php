...
<script type="text/javascript" src="res/plugins/angularjs/user.js"></script>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'index.php/admin/jobs/view'; ?>">Jobs</a></li>
        ...
        <!-- Main content -->
        <section class="content" data-ng-app="user">
          ...
          <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" accept-charset="utf-8" method="POST" action="<?php echo base_url() . 'index.php/admin/jobs/add'; ?>" data-ng-controller="usersCtrl as usrCtrl">
                  <div class="box-body">


                    <div class="form-group">
                      <label for="exampleInputEmail1">Company :</label>
                      <select name="company" id="company" class="my_select" data-ng-change="usrCtrl.getUsers(client_id)" data-ng-model="client_id">
                    ...
                    <div class="form-group">
                      ...
                      <select name="link_user_id" id="link_user_id" class="my_select" >
                          <option value="">Please assign a user</option>

                          <?php 
                              

                              if(isset($users_data) && ($users_data->num_rows() > 0) )
                              {
                                  foreach ($users_data->result() as  $user_row) {
                                      
                                    echo '<option  value="'. $user_row->id .'" '. set_select("link_user_id", $user_row->id, isset($link_user_id)? $link_user_id == $user_row->id : '') .'>'. $user_row->first_name . ' '.  $user_row->last_name .'</option>';
                          ...
                          ?>
                            ...
                            <option data-ng-repeat="user in usrCtrl.users" value="{{user.id}}">{{user.user_name}}</option>

                      </select>

                      <?php if( form_error('link_user_id') )
                           {
                      ?>
                              <div class="col-lg-12 form-group has-error">
                                  <p class="help-block">
                                      <?php echo isset($errors['link_user_id'])?$errors['link_user_id']:'';?>
                                  </p>
                              </div>
